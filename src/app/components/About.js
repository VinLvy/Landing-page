    ...
    <section id="about" className="py-16 bg-gray-100 bg-gray-900">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-16">
          <div className="p-8 bg-gray-800 rounded-2xl shadow-lg text-left transform hover:scale-105 transition duration-300">
            <h3 className="text-3xl font-bold text-blue-400"> Misi Kami</h3>
          ...
          <div className="p-8 bg-gray-800 rounded-2xl shadow-lg text-left transform hover:scale-105 transition duration-300">
            <h3 className="text-3xl font-bold text-blue-400"> Visi Kami</h3>
            <p className="text-gray-300 mt-4 text-lg">
